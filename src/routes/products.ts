...
router.post('/', middleware.authenticate, validator.validateType('product'), productController.create);

router.put('/:productId', middleware.authenticate, validator.validateType('product'), productController.update);
